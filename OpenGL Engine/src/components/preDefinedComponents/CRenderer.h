...
struct CRenderer : Component
{
	...
	CRenderer() : tileCount(1), transparent(false), fakeLighting(false), multiTexture(false), disableSpecular(false), hasAtlas(false), atlasIndex(0), atlasRowCount(1), skyboxReflection(false) {}
